  ...
  return (
    <>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-white">{t.financialDashboard}</h1>
          <p className="text-slate-400 mt-1">{t.welcomeBack}, {userName}, {t.inDepthBreakdown.toLowerCase()}</p>
        </div>
